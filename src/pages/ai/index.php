    ...
    <div class="w-96 bg-white shadow-xl border rounded-lg">
      ...
      <div class="p-2 border-t">
        <div class="relative flex">
          ...
          <button id="send-button" class="ml-2 px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
            Send
          </button>
        </div>
      </div>
