...
$hostManage = new host_controller();
...
$count = $hostManage->countAllHosts($searchQuery);
...
<main class="content-wrapper">
  <div class="content">
    <div class="mb-4">
      <h2 class="uppercase font-bold text-blue-900 text-lg">Host Management</h2>
      <p class="text-gray-500 text-sm">Manage all hosts for your properties and accommodations.</p>
    </div>
        ...
        <div class="flex items-center justify-between w-full">
          <div>
            <button type="button"
              ...
              <i data-lucide="user-plus" class="w-[16px] mr-1"></i>
              Add new host
            </button>
          </div>
          <?php require_once __DIR__ . '/./modal/add-new-host-modal.php' ?>
