...
$bookingManage = new booking_controller();
...
$count = $bookingManage->countAllBookings($searchQuery, $userRole, $userId);
$totalPages = ceil($count / $pageSize);
?>
<main class="content-wrapper">
  <div class="content">
    <div class="mb-4">
      <h2 class="uppercase font-bold text-blue-900 text-lg">Unit Reservation and Bookings</h2>
      <p class="text-gray-500 text-sm">Manage all unit reservations and bookings, including creating new reservations and viewing existing ones.</p>
    </div>
      ...
      <div class="overflow-x-auto border rounded-lg border-gray-200 dark:border-gray-700">
        <table class="w-full text-sm text-left rtl:text-right text-gray-600 dark:text-gray-400">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <?php require_once __DIR__ . '/./components/booking-table.php'; ?>
          </tbody>
        </table>
      </div>
    </div>
