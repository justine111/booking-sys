...
$userManage = new user_controller();
...
$count = $userManage->countAllUsers($searchQuery);
...
<main class="content-wrapper">
  <div class="content">
    <div class="mb-4">
      <h2 class="uppercase font-bold text-blue-900 text-lg">User Management</h2>
      <p class="text-gray-500 text-sm">Manage all users, including their profiles, roles, and access permissions.</p>
    </div>
    ...
    <div class="relative">
      <div class="flex flex-col gap-4 pb-2">
        <div class="flex items-center justify-between w-full">
          <div>
            <button type="button"
              data-modal-show="add-new-user"
              data-modal-target="add-new-user"
          ...
          <?php require_once __DIR__ . '/./modal/add-new-user-modal.php' ?>
      ...
      <div class="overflow-x-auto border rounded-lg border-gray-200 dark:border-gray-700">
        <table class="w-full text-sm text-left rtl:text-right text-gray-600 dark:text-gray-400">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <?php require_once __DIR__ . '/./components/user-table.php'; ?>
          </tbody>
        </table>
      </div>
    </div>
